...
| ◐ | `P01` | [Design tokens, base layout, and the ADR-0003 invariants](P01-design-tokens-shell.md) | in-progress | P00 |  |
...
| ☐ | `P08` | [UI primitives, including the currency field](P08-ui-primitives.md) | pending | P01 | waiting on P01 |
...
| ☐ | `P13` | [Rates pages, sources register and changelog — generated from data](P13-rates-and-sources-pages.md) | pending | P09, P03 | waiting on P09, P03 |
